...
#sed "s/HDFS_NAMENODE_RPC_HOST/$HDFS_NAMENODE_RPC_HOST/" ${HADOOP_INSTALL_DIR}/etc/hadoop/core-site.xml > ${HADOOP_INSTALL_DIR}/etc/hadoop/core-site.new.xml
#mv ${HADOOP_INSTALL_DIR}/etc/hadoop/core-site.new.xml ${HADOOP_INSTALL_DIR}/etc/hadoop/core-site.xml
